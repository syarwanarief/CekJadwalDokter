        ...
        navigationView.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(MenuItem menuItem) {
                ...
                switch (menuItem.getItemId()) {
                    case R.id.beranda:
                        Intent intent = new Intent(Bantuan.this, Home.class);
                        finish();
                        startActivity(intent);
                        return true;
                    case R.id.akun:
                        Intent intent10 = new Intent(Bantuan.this, InfoAkun.class);
                        finish();
                        startActivity(intent10);
                        return true;
                    case R.id.maps:
                        Intent intent11 = new Intent(Bantuan.this, LokasiActivity.class);
                        finish();
                        startActivity(intent11);
                        return true;
                    case R.id.musik:
                        Intent intent1 = new Intent(Bantuan.this, Musik.class);
                        finish();
                        startActivity(intent1);
                        return true;
                    case R.id.bantuan:
                        Intent intent2 = new Intent(Bantuan.this, Bantuan.class);
                        finish();
                        startActivity(intent2);
                        return true;
                    case R.id.tentang:
                        Intent intent3 = new Intent(Bantuan.this, Tentang.class);
                        finish();
